...
<span style="font-size: 14px; color: rgb(51, 51, 51)">以上执行会创建 3 层镜像。可简化为以下格式：</span>
...
<span style="font-size: 14px; color: rgb(51, 51, 51)">容器内会默认运行以下命令，启动主进程(/etc/nginx/new.conf:假设容器内已有此文件)</span>
